                    ...
                    <CardContent className="bg-white rounded-[10px] px-[25px] py-[20px] mt-[10px]">
                      ...
                      <div className="border-t mt-[30px] pt-[15px]">
                        {question?.title?.map((item: any, index: any) => (
                          <div key={`questionsArr${index}`} className="border-[0.3px] mt-[15px] px-[20px] py-[20px] justify-between flex items-center rounded-[5px] bg-[#F9FAFB]">
                            <div className="flex gap-[18px]">
                              <img src='/images/apps.svg' alt='apps' />
                              <p className="font-regular text-[#000000] text-sm">{item}</p>
                            </div>
                            <div className="flex gap-[15px]">
                              <img src='/images/pen-circle.svg' alt='edit' />
