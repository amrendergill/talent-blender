...
const initialValue: any = { location: "", types: "", department: "", city: "", remote: false, sortBy: "" }
export default function Jobs() {
    ...
    const featuredJobs = async (addOld: any = false, page: any = pagination?.page) => {
        ...
        setPagination({ ...pagination, hasNextPage: response?.data?.job_data?.page_info?.has_next_page, page: response?.data?.job_data?.page_info?.page })
    };
            ...
            <div className="flex">
                <div className="min-w-[260px] relative w-[260px] ">
                    <div className="top-[90px] sticky pr-[15px] w-[100%]">
                                        ...
                                        <div>
                                            <p className="commonCheckSmRound mb-0">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFilterBy({ ...filterBy, sortBy: filterBy?.sortBy == "1" ? "" : "1" })
                                                    }
                                                />
                                                <label
                                                    htmlFor={`1 Day`}
                                            ...
                                            <p className="commonCheckSmRound mb-0">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFilterBy({ ...filterBy, sortBy: filterBy?.sortBy == "3" ? "" : "3" })
                                                    }
                                                />
                                                <label
                                                    htmlFor={`3 Day`}
                                            ...
                                            <p className="commonCheckSmRound mb-0">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFilterBy({ ...filterBy, sortBy: filterBy?.sortBy == "7" ? "" : "7" })
                                                    }
                                                />
                                                <label
                                                    htmlFor={`1 Week`}
                                        ...
                                        <div className="">
                                            <p className="commonCheckSmRound mb-0">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFilterBy({ ...filterBy, sortBy: filterBy?.sortBy == "30" ? "" : "30" })
                                                    }
                                                />
                                                <label
                                                    htmlFor={`1 Months`}
                                            ...
                                            <p className="commonCheckSmRound mb-0">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFilterBy({ ...filterBy, sortBy: filterBy?.sortBy == "90" ? "" : "90" })
                                                    }
                                                />
                                                <label
                                                    htmlFor={`3 Months`}
                            ...
                            <div className="flex justify-between">
                                <p className="mb-1 commonCheckSmRound">
                                    <input
                                        ...
                                        onChange={(e: any) => {
                                            setFilterBy({ ...filterBy, remote: e.target.checked });
                                        }}
                                    />
                                    <label
                        ...
                        <Select value={`${filterBy?.city}`} key={`${filterBy?.city}`} onValueChange={(e: any) => {
                                ...
                                <SelectGroup>
                                    {filters?.cities?.length > 0 &&
                                        filters?.cities?.map((item: any, index: number) => (
                                            < SelectItem className="text-[11px]" value={item?.length > 0 ? item : "NA"} key={`citiesFilter${item}${index}`}>{item}</SelectItem>
                                        ))
                                    }
                                </SelectGroup>
                            </SelectContent>
                        ...
                        <div className="mt-[15px]">
                            <Select value={`${filterBy?.department}`} key={`${filterBy?.department}`} onValueChange={(e: any) => {
                                        ...
                                        {filters?.departments
                                            ...
                                            filters?.departments
                                                ?.map((item: any, index: number) => (
                                                    < SelectItem className="text-[11px]" value={item?.length > 0 ? item : "NA"} key={`departmentsFilter${item}${index}`}>{item}</SelectItem>
                                                ))
                                        }
                                    </SelectGroup>
                                </SelectContent>
                        ...
                        <div className="mt-[15px]">
                            <Select value={`${filterBy?.types}`} key={`${filterBy?.types}`} onValueChange={(e: any) => {
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        {filters?.job_types?.length > 0 &&
                                            filters?.job_types?.map((item: any, index: number) => (
                                                < SelectItem className="text-[11px]" value={item?.length > 0 ? item : "NA"} key={`job_typesFilter${item}${index}`}>{item}</SelectItem>
                                            ))
                                        }
                                    </SelectGroup>
                                </SelectContent>
                        ...
                        <div className="mt-[15px]">
                            <Select value={`${filterBy?.locations}`} key={`${filterBy?.locations}`} onValueChange={(e: any) => {
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        {filters?.locations?.length > 0 &&
                                            filters?.locations?.map((item: any, index: number) => (
                                                < SelectItem className="text-[11px]" value={item?.country_code?.length > 0 ? item?.country_code : "NA"} key={`locationsFilter${item?.country_code}${index}`}>{item?.country_name}</SelectItem>
                                            ))
                                        }
                                    </SelectGroup>
                                </SelectContent>
                        ...
                        data?.map((item: any) => (
                            <Card className="mb-[20px] w-[100%]">
                                    ...
                                    <div className={` mt-3`}>
                                        <div className={"flex flex-wrap"}>
                                            {item?.skills
                                                ...
                                                ?.map((item: any) => (
                                                    <span
                                                        className={`skillcard py-1 me-2 mb-1 px-3`}
                                                    >
                                                        {item}
                                                    </span>
                                                ))}
                                ...
                                <CardFooter className="px-0 pb-0">
                                    <a className="w-[100%]" href={item?.job_link} target="_blank">
                                        <button
