  ...
  return (
    <>
      <main className="bg-white flex">
        <div className="border-r w-full">
          ...
          <div className="my-[25px] pr-3">
            ...
            <div className="my-10">
              ...
              <ul
                className="text-xs flex flex-col gap-[10px] ml-5"
        ...
        <div className="ml-3 flex flex-col w-[370px] max-w-[370px] min-w-[370px]  ">
          <div className="mt-[30px] pb-5 border-b">
            <CompanyJobDetails />
          </div>
          <div className="mt-5">
            <p className="text-xs">Similar Jobs</p>
